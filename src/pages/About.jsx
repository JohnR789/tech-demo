...
const About = () => (
  <main style={{ paddingTop: 110, minHeight: "70vh", background: "#fffef9" }}>
    <div style={{
      ...
      fontFamily: "'Playfair Display', serif", color: "#432c12"
    }}>
      <h2 style={{ fontSize: "2.4rem", fontWeight: 800, marginBottom: 22, color: "#ad5b00" }}>Meet Autumn Realty</h2>
      <img src="/logo192.png" alt="Autumn Realty" style={{ width: 92, marginBottom: 18 }} />
      <p style={{ fontSize: "1.19rem", lineHeight: 1.6, color: "#7d5232", margin: "0 auto 38px auto" }}>
